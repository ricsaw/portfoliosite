...
const ContactInfo = ({ name, email, location }) => {
  ...
  return (
    ...
    >
      ...
      <p className="infoDescription">Open for opportunities. I would love to connect with anyone who shares a passion for technology or is interested in collaborating on a project together! </p>
